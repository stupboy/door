...
sql="update Admin set is_ok='False' where id="&Request("id")
Conn.execute(sql)
  ...
  <tr valign="top">
	...
	<br>
      <table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
		...
		<tr align="center" bgcolor="#F2FDFF">
          ...
          <td align="left"><input name="RealName" type="text" id="RealName"></td>
        </tr>
	...
	<br>
     <%if action="list" then%>
      <table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
        <tr align="center" bgcolor="#F2FDFF">
          <td colspan="6"  class="optiontitle">用户列表</td>
        </tr>
        <tr align="center" bgcolor="#ebf0f7">
          <td width="10%">序号</td>
          <td width="20%">用户名</td>
...
<%
set rs=server.createobject("adodb.recordset") 
sql="select * from Admin where is_ok='True' " 
...
%>
        <tr align="right" bgcolor="#ebf0f7">
          <td colspan="6"><a href="admin.asp?action=add">添加用户</a></td>
        </tr>
      </table> 
<%
end if
...
<br>
	  <table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
		...
		<tr align="center" bgcolor="#F2FDFF">
          <td width="10%" align="right">用户名：</td>
          <td align="left"><input name="Username" type="text" id="Username" value="<%=rs("Username")%>" readonly="readonly"/></td>
        </tr>
		<tr align="center" bgcolor="#F2FDFF">
          <td width="10%" align="right">姓名：</td>
          <td align="left"><input name="RealName" type="text" id="RealName" value="<%=rs("Realname")%>"></td>
        </tr>
		<tr align='center' bgcolor='#FFFFFF'>
		  <td align='right' bgcolor="#FFFFFF"> 登陆密码：</td>
